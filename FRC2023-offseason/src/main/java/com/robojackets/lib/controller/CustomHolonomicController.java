 ...
 */
public class CustomHolonomicController {
   ...
   */
  public CustomHolonomicController(
  ...
  public ChassisSpeeds calculate(
      Pose2d currentPose, Pose2d referencePose, ChassisSpeeds referenceSpeeds) {
    ...
    double xFeedback = this.xController.calculate(currentPose.getX(), referencePose.getX());
    double yFeedback = this.yController.calculate(currentPose.getY(), referencePose.getY());
    double rotationFeedback =
        this.rotationController.calculate(
            currentPose.getRotation().getRadians(), referencePose.getRotation().getRadians());
