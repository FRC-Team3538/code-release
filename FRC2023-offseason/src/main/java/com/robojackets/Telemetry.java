...
public class Telemetry {
  ...
  public void telemeterize(SwerveDriveState state) {
    ...
    speed.set(
        Math.sqrt(
            state.ChassisSpeeds.vxMetersPerSecond * state.ChassisSpeeds.vxMetersPerSecond
                + state.ChassisSpeeds.vyMetersPerSecond * state.ChassisSpeeds.vyMetersPerSecond));
