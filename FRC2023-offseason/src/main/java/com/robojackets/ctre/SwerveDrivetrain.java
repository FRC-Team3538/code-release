...
public class SwerveDrivetrain {
  ...
  protected Rotation3d m_orientation;
  ...
  public boolean isRecent(double timestamp) {
    try {
      m_stateLock.writeLock().lock();

      return m_odometry.isRecent(timestamp);
    } finally {
      m_stateLock.writeLock().unlock();
    }
  }
   ...
   */
  public void setVisionMeasurementStdDevs(Matrix<N4, N1> visionMeasurementStdDevs) {
    try {
      m_stateLock.writeLock().lock();
