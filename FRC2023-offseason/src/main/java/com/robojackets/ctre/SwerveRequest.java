...
public interface SwerveRequest {
  ...
  public class RobotCentricFacingAngle implements SwerveRequest {
    ...
    public StatusCode apply(
      ...
      ChassisSpeeds speeds =
          ChassisSpeeds.discretize(toApplyX, toApplyY, toApplyOmega, parameters.updatePeriod);
  ...
  public class FollowTrajectory implements SwerveRequest {
    ...
    public StatusCode apply(
        SwerveControlRequestParameters parameters, SwerveModule... modulesToApply) {
      var state = Trajectory.sample(parameters.timestamp - StartTime);

      Logger.recordOutput("Swerve/TrajectoryState/time", state.getTimestamp());
      Logger.recordOutput(
      ...
      Logger.recordOutput("Swerve/TrajectoryState/pose", state.getPose());
      Ref.setPose(state.getPose());
      ...
      speeds = ChassisSpeeds.discretize(toApplyX, toApplyY, toApplyOmega, parameters.updatePeriod);
    ...
    public FollowTrajectory withTrajectory(Trajectory traj) {
      this.Trajectory = traj;
      return this;
    }

    public FollowTrajectory withStartTime(double startTime) {
      this.StartTime = startTime;
      return this;
    }

    public FollowTrajectory withFieldObject(FieldObject2d object) {
      this.Ref = object;
      return this;
    }
     ...
     * @return this request
     */
    public FollowTrajectory withDeadband(double deadband) {
      this.Deadband = deadband;
      return this;
    }
    /**
     ...
     * @return this request
     */
    public FollowTrajectory withRotationalDeadband(double rotationalDeadband) {
      this.RotationalDeadband = rotationalDeadband;
      return this;
    }
     ...
     * @return this request
     */
    public FollowTrajectory withDriveRequestType(SwerveModule.DriveRequestType driveRequestType) {
      this.DriveRequestType = driveRequestType;
      return this;
    }
    /**
     ...
     * @return this request
     */
    public FollowTrajectory withSteerRequestType(SwerveModule.SteerRequestType steerRequestType) {
      this.SteerRequestType = steerRequestType;
      return this;
    }
  }
