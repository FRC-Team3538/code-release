...
public class RJSwerveRequest {
  ...
  public static class RJFieldCentric implements SwerveRequest {
    ...
    public StatusCode apply(
      ...
      if (m_lastAppliedState != null
          && speeds.vxMetersPerSecond == 0
          && speeds.vyMetersPerSecond == 0
          && speeds.omegaRadiansPerSecond == 0) {
        for (int i = 0; i < modulesToApply.length; i++) {
          states[i].angle = m_lastAppliedState[i].angle;
        }
      }
  ...
  public static class RJFieldCentricFacingAngle implements SwerveRequest {
    ...
    public StatusCode apply(
      ...
      this.RotationProfileFollower.setGoalState(TargetDirection, 0);
  ...
  public static class RJRobotCentricFacingPoint implements SwerveRequest {
    ...
    public StatusCode apply(
        SwerveControlRequestParameters parameters, SwerveModule... modulesToApply) {
      var fieldCentric =
          ChassisSpeeds.fromRobotRelativeSpeeds(Speeds, parameters.currentPose.getRotation());
      var toApply =
          ForwardReference.adjustChassisSpeeds(fieldCentric, parameters.operatorForwardDirection);
     ...
     * @return this request
     */
    public RJRobotCentricFacingPoint withSpeeds(ChassisSpeeds speeds) {
      this.Speeds = speeds;
      return this;
    }
     ...
     * @return this request
     */
    public RJRobotCentricFacingPoint withTargetPoint(Translation2d target) {
      this.target = target;
      return this;
    }
     ...
     * @return this request
     */
    public RJRobotCentricFacingPoint withDeadband(double deadband) {
      this.Deadband = deadband;
      return this;
    }
    /**
     ...
     * @return this request
     */
    public RJRobotCentricFacingPoint withRotationalDeadband(double rotationalDeadband) {
      this.RotationalDeadband = rotationalDeadband;
      return this;
    }
    /**
     ...
     * @return this request
     */
    public RJRobotCentricFacingPoint withCenterOfRotation(Translation2d centerOfRotation) {
      this.CenterOfRotation = centerOfRotation;
      return this;
    }
