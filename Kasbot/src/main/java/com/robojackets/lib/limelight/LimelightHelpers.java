...
package com.robojackets.lib.limelight;
...
public class LimelightHelpers {
  ...
  private static Pose2d toPose2D(double[] inData) {
    return toPose3D(inData).toPose2d();
  }
  ...
  public static double getLimelightNTEntryTime(String tableName, String entryName) {
    return getLimelightNTTableEntry(tableName, entryName).getLastChange();
  }
  ...
  public static LimelightResults getLatestResults(String limelightName) {
    ...
    try {
      ...
      results.targetingResults.timestamp_RIOFPGA_capture =
          getLimelightNTEntryTime(limelightName, "json") * .000001;
