...
public class SwerveModule {
  ...
  private final VelocityVoltage m_velocityVoltageSetter =
   ...
   * @param driveRequest The control request to apply to the motor for use during characterization
   */
  public void applyCharacterization(Rotation2d steerTarget, ControlRequest driveRequest) {
