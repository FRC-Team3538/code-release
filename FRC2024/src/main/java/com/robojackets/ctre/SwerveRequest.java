...
public interface SwerveRequest {
  ...
  public enum ForwardReference {
    ...
    public ChassisSpeeds adjustChassisSpeeds(ChassisSpeeds original, Rotation2d operatorForward) {
      switch (this) {
        case OperatorPerspective:
          return ChassisSpeeds.fromRobotRelativeSpeeds(original, operatorForward);
        case RedAlliance:
        default:
          return original;
      }
    ...
    public Rotation2d adjustRotation2d(Rotation2d original, Rotation2d operatorForward) {
      switch (this) {
        case OperatorPerspective:
          return original.rotateBy(operatorForward);
        case RedAlliance:
        default:
          return original;
      }
  ...
  public class FieldCentric implements SwerveRequest {
    ...
    public StatusCode apply(
      ...
      ChassisSpeeds toApply =
          ForwardReference.adjustChassisSpeeds(
              new ChassisSpeeds(VelocityX, VelocityY, RotationalRate),
              parameters.operatorForwardDirection);
      double toApplyX = toApply.vxMetersPerSecond;
      double toApplyY = toApply.vyMetersPerSecond;
      double toApplyOmega = toApply.omegaRadiansPerSecond;
  ...
  public class FieldCentricFacingAngle implements SwerveRequest {
    ...
    public StatusCode apply(
      ...
      ChassisSpeeds toApply =
          ForwardReference.adjustChassisSpeeds(
              new ChassisSpeeds(VelocityX, VelocityY, 0), parameters.operatorForwardDirection);
      double toApplyX = toApply.vxMetersPerSecond;
      double toApplyY = toApply.vyMetersPerSecond;
