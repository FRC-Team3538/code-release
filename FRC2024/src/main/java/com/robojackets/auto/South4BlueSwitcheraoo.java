...
public class South4BlueSwitcheraoo extends CommandBasedAuton {
  ...
  public South4BlueSwitcheraoo(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("south 4 blue note switch");
