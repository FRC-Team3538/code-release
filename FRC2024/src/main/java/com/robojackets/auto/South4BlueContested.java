...
public class South4BlueContested extends CommandBasedAuton {
  ...
  public South4BlueContested(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("south contested blue auto");
