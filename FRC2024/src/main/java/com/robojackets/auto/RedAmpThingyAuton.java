...
public class RedAmpThingyAuton extends CommandBasedAuton {
  public static final String NAME = "Auton::RedAmpThingyAuton";
  ...
  public RedAmpThingyAuton(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("red north speedy boi");
