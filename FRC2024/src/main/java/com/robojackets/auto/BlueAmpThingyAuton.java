...
public class BlueAmpThingyAuton extends CommandBasedAuton {
  public static final String NAME = "Auton::BlueAmpThingyAuton";
  ...
  public BlueAmpThingyAuton(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("north speedy boi");
