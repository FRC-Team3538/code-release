...
public class South4BlueAuton extends CommandBasedAuton {
  ...
  public South4BlueAuton(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("south 4 blue improved");
