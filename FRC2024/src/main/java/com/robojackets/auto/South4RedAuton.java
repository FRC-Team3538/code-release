...
public class South4RedAuton extends CommandBasedAuton {
  ...
  public South4RedAuton(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("south 4 red improved");
