...
public class Center4BlueContested extends CommandBasedAuton {
  ...
  public Center4BlueContested(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("center contested blue auto");
