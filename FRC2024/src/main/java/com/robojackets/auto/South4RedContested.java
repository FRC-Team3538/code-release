...
public class South4RedContested extends CommandBasedAuton {
  ...
  public South4RedContested(RobotContainer io) {
    super(NAME);

    m_io = io;

    var trajectories = Choreo.getTrajectoryGroup("south contested red auto");
