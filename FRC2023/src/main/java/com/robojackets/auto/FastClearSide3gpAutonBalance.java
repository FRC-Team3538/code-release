...
public class FastClearSide3gpAutonBalance extends Auton {
  ...
  public FastClearSide3gpAutonBalance(RobotContainer io) {
    ...
    this.red_trajectory =
        List.of(
            ...
            TrajectoryManager.getInstance()
                .getTrajectory("fast-clear-project-Red Grid 2 to Bridge.path.json"));
