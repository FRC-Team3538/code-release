...
public class BiggerBoiLeft extends Auton {
  private RobotContainer io;
  double targetYaw = 0.0;

  public BiggerBoiLeft(RobotContainer io) {
    this.io = io;
  ...
  public void Periodic() {
    ...
    switch (getStep()) {
      ...
      case 4:
        ...
        io.swerve.DriveRobotCentric(new ChassisSpeeds(-1.7, 0.02, yawLockCmd));

        //   boolean RobotOnDescent = Math.abs(io.swerve.ioInputs.getPitchRadians() * 180.0 /
        // Math.PI) < 15.0;

        if (getStepElapsed() > 2.85) {
          Step();
        }
      ...
      case 6:
        ...
        io.arm.GoTo(ArmSetpoint.GROUND);
      ...
      case 9:
        ...
        io.swerve.DriveRobotCentric(new ChassisSpeeds(2.2, 0.5, yawLockCmd));
      ...
      case 10:
        ...
        yawLockCmd = yawError * yawKP;
        yawLockCmdMax = 0.5 * Constants.SwerveDrive.MaxAngularVelocityRadiansPerSecond;
        io.swerve.DriveRobotCentric(new ChassisSpeeds(1.45, 0, yawLockCmd)); // 2.6 next change?
      ...
      case 11:
        ...
        if (io.arm.getElbowPosition() < 45.0) {
