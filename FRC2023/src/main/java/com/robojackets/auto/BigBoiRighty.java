...
public class BigBoiRighty extends Auton {
  private RobotContainer io;
  double targetYaw = 0.0;

  public BigBoiRighty(RobotContainer io) {
    this.io = io;
  ...
  public void Periodic() {
    ...
    switch (getStep()) {
      ...
      case 6:
        ...
        io.swerve.DriveRobotCentric(new ChassisSpeeds(2.1, 0, yawLockCmd));
      ...
      case 7:
        io.swerve.DriveRobotCentric(new ChassisSpeeds(1.35, 0.0, yawLockCmd)); // 2.6 next change?
